...
namespace MvcProject.Migrations
{
    ...
    [Migration("20191010163331_ImageTitleMigration")]
    partial class ImageTitleMigration
    {
            ...
            modelBuilder.Entity("MvcProject.Models.Review", b =>
                {
                    ...
                    b.HasData(
                        new { ID = 1, Content = "This Car Is Super Fast", Image = "/Images/mclaren-570s-spider-design-edition.jpg", ProductID = 1, Rating = 5, Title = "MycLaren 570 Spyder", UserName = "SpyderMan" },
                        new { ID = 2, Content = "Very Expensive", Image = "/Images/mclaren-570s-spider-design-edition.jpg", ProductID = 1, Rating = 1, Title = "MycLaren 570 Spyder", UserName = "Janitor" },
